...
## Project Structure
    ...
    ├── wispy_recipe_dev_67730  # Django project configurations
...
1. Clone this repo and `cd wispy_recipe_dev_67730`
...
2. Clone this repo and `cd wispy_recipe_dev_67730`
